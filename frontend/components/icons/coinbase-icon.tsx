export function CoinbaseIcon({ className = "w-full h-full" }: { className?: string }) {
  return (
    <svg width="800" height="800" viewBox="0 0 1024 1024" xmlns="http://www.w3.org/2000/svg" className={className}>
