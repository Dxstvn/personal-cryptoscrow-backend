...
/**
 * @title UniversalEscrowServiceV2
 * @notice Enhanced escrow service with proper chain ID mapping for LayerZero
 * @dev Fixes the chain ID vs endpoint ID mismatch issue
 */
contract UniversalEscrowServiceV2 is Ownable, ReentrancyGuard {
    ...
    function _handleCrossChainRelease(bytes32 escrowId, EscrowDeposit memory escrow, uint32 targetEndpointId) internal {
        ...
        // Verify msg.value covers the fee
